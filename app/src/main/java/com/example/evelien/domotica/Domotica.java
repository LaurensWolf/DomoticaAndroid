...
public class Domotica extends ActionBarActivity {
    ...
    public void lampjeb(View v) throws IOException, URISyntaxException {
    ...
    public void onClick(View view) {
        ...
        task.execute(new String[] { "http://192.168.2.179/?led1" });
